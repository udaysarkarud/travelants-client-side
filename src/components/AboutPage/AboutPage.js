            ...
            <div className="row">
                <div className="col-6">
                    ...
                    <div className="blog-details">
                        <h3 className="mt-4">Shaping the future of travel</h3>
                ...
                <div className="col-6">
                    <div className="blog-details">
                        ...
                        <p>During the second wave of Covid-19, Tiger reserves and National Parks had remained closed in April and May, as a precautionary measure.However, forest Minister Vijay Shah recently announced that the national parks and tiger reserves in Madhya Pradesh will remain open from June 1 to June 30.Tiger reserves like Bandhavgarh, Kanha, Satpura, Pench, and Panna are going to stay open all June.Another cause of celebration that the tiger reserves in Madhya Pradesh have is that, with a population of 526 tigers, it re-achieved the top slot in the 2018 census. They showed the maximum number of tigers (3,421) which was followed by Karnataka (1,783) and then Maharashtra (1,690). Forest officials have also spotted 41 new tiger cubs at Bandhavgarh Tiger Reserve.</p>
                    </div>
                </div>
            </div>
        </section>
